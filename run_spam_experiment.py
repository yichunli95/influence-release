...
# Loading 20 spam and 20 ham for now (change in line 28 - 29 in load_spam.py)
data_sets = load_spam()
# "Spam" and "Ham"
num_classes = 2
...
experiments.viz_top_influential_examples(tf_model, range(tf_model.data_sets.test.num_examples))
